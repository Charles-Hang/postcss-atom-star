...
function _default(getConfig) {
  return function processor(css) {
    ...
    return (0, _postcss.default)([(0, _substituteRiacssAtRules.default)(processedPlugins.utilities), (0, _substituteScreenAtRules.default)(config), (0, _substituteClassApplyAtRules.default)(processedPlugins.utilities)]).process(css, {
