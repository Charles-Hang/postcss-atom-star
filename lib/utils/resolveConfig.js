...
function mergeExtends(theme, extend) {
  return _lodash.default.mergeWith(theme, extend, (themeValue, extendValue) => {
    if (!_lodash.default.isFunction(themeValue) && !_lodash.default.some(extendValue, _lodash.default.isFunction)) {
      return _lodash.default.mergeWith({}, themeValue, ...extendValue);
    }

    return themeGetter => _lodash.default.mergeWith({}, ...[themeValue, ...extendValue].map(e => _lodash.default.isFunction(e) ? e(themeGetter) : e));
  });
}
