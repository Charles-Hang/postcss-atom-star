...
const plugins = [_display.default, _overflow.default, _position.default, _visibility.default, _zIndex.default, _flex.default, _margin.default, _padding.default, _width.default, _height.default, _font.default, _lineHeight.default, _textAlign.default, _verticalAlign.default, _whitespace.default, _wordBreak.default, _color.default, _background.default, _border.default, _cursor.default, _outline.default, _resize.default]; // const plugins = [display, textAlign, color];
